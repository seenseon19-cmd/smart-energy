...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    ...
    'energySavingTitle': {'en': 'Save more, consume smarter', 'ar': 'وفّر أكثر، واستهلك بذكاء'},
    'energySavingBody': {'en': 'Turning off unnecessary devices during peak hours can reduce your monthly bill.', 'ar': 'إيقاف الأجهزة غير الضرورية وقت الذروة يقلل من فاتورتك الشهرية بشكل فعال.'},
