...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    ...
    'energySavingBadge': {'en': 'Energy efficiency', 'ar': 'ترشيد الطاقة'},
    'energySavingTitle': {'en': 'Save electricity intelligently', 'ar': 'وفّر الكهرباء بذكاء'},
    'energySavingBody': {'en': 'Monitor your energy use and make smarter decisions to reduce consumption.', 'ar': 'راقب استهلاكك للطاقة واتخذ قرارات أذكى لتقليل الاستهلاك.'},
    'energySavingAction': {'en': 'View saving tips', 'ar': 'عرض نصائح التوفير'},
    'energySavingDialogTitle': {'en': 'Smart electricity-saving tip', 'ar': 'نصيحة ذكية لتوفير الكهرباء'},
    'energySavingDialogBody': {'en': 'SmartEnergy monitors your loads and helps protect you from voltage rises. Distribute heavy appliance usage and avoid running them all at once.', 'ar': 'يراقب SmartEnergy الأحمال ويساعدك على الحماية من ارتفاع الجهد. نوصي بتوزيع استخدام الأجهزة الثقيلة وتجنب تشغيلها دفعة واحدة.'},
    ...
    'planActivated': {'en': 'Plan {name} activated successfully', 'ar': 'تم تفعيل باقة {name} بنجاح'},
    ...
    'invalidWattage': {'en': 'Enter a valid wattage greater than 0', 'ar': 'يرجى إدخال استهلاك واط صالح أكبر من 0'},
    'deviceLimitReached': {'en': 'The device limit for this space has been reached', 'ar': 'تم الوصول للحد الأقصى لأجهزة هذه المساحة'},
    'relayAlreadyUsed': {'en': 'This relay is already used by "{name}"', 'ar': 'المنفذ المختار مشغول مسبقاً بجهاز "{name}"'},
    ...
    'spaceAlreadyExists': {'en': 'A space named "{name}" already exists. Choose another name.', 'ar': 'توجد مساحة باسم "{name}" مسبقاً. يرجى اختيار اسم مختلف.'},
